	          ...
	          <div class="panel panel-info">
	            <div class="panel-heading">
	              <h4 class="panel-title"></h4>
         		    <h4><img src="/resources/HTML/UI/Flat-UI-Pro-1.3.2/docs/assets/img/icons/paper-bag.svg" style="max-width: 2.7%; alt="" />&nbsp;&nbsp;PPOMPPU UPDATE</h4>
	               </div>
	                <div class="panel-body">
	                  <div class="row">
                        <div class="col-md-12">
				          <form action="/ppomppuBoardUpdate" class="form" enctype="multipart/form-data" method="post">
				            <div class="form-group">
				              ...
				              <div class="col-md-4">
				                <div class="form-group has-warning" style="position: absolute; right: 50px; top: 0px; width:86%;">
				              	...
				              	<input type="text" name="title" value="${ppomppuBoard.title}" class="form-control" style="width:66.5%;">
				              </div>
			              	 <div class="form-group">
				         		<textarea class="form-control" name="content" rows="10" >${ppomppuBoard.content}</textarea>
				        	</div>
					        	<input type="hidden" name="id" value="${ppomppuBoard.id}"/>
