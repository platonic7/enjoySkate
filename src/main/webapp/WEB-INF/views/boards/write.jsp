	          ...
	          <div class="panel panel-info">
	            <div class="panel-heading">
	              <h4 class="panel-title"></h4>
         		    <h4><img src="/resources/HTML/UI/Flat-UI-Pro-1.3.2/docs/assets/img/icons/donut.svg" style="max-width: 2.7%; alt="" />&nbsp;&nbsp;BOARD WRITE&nbsp;&nbsp;<img src="/resources/HTML/UI/Flat-UI-Pro-1.3.2/docs/assets/img/icons/donut.svg" style="max-width: 2.7%; alt="" /></h4>
	               </div>
	                <div class="panel-body">
	                  <div class="row">
                        <div class="col-md-12">
				          <form action="/boards" class="form" enctype="multipart/form-data" method="post">
				            <div class="form-group">
				              ...
				              <div class="col-md-4">
			              	 ...
			              	 <div class="form-group">
				         		<textarea class="form-control" name="content" rows="10" >${boardList.content}</textarea>
				        	</div>
