	        ...
	        <div class="col-md-12">
	          <div class="panel panel-info">
	            <div class="panel-heading">
	              <h3 class="panel-title"><img src="/resources/HTML/UI/Flat-UI-Pro-1.3.2/docs/assets/img/icons/mic.svg" style="max-width: 3%; alt="" />&nbsp;&nbsp;${board.title}</h3>
	            ...
	            <div class="panel-body">
	              ...
	              ${board.user.username}&nbsp;&nbsp; 입력&nbsp;&nbsp;${board.updatedTime}&nbsp;
				  <a href="/boards/${board.id}/update" class="btn">Update</a>
	              <a href="/boards/${board.id}/delete" class="btn">Delete</a>
	   			</div>
	   			 <p style="clear:both;">&nbsp;</p>
		         <img alt="" style="max-width: 100%; height: auto;" vspace="20" src="<c:url value="${board.imagePath }" />" >
					<div id="test">
					<pre><h3><c:out value="${board.content}"/></h3></pre>
					</div>
		       </div>
		     </div>
		   </div>
...
<div class="container">
	...
	<table>
		<tr>
	  			<td><input name="boardId" type="hidden" value="${board.id }"></td>
 ...
 <br />
 <div class="container">
	   <c:forEach items="${board.boardcommentList}" var="boardComment">
	     <dl>
	  		...
	  		<dd><a href="/boards/${boardComment.id}/commentUpdate" class="btn">UpDate</a>
	  		<a href="/boards/${boardComment.id}/commentDelete" class="btn">Delete</a></dd>
		</dl>
	  </c:forEach>
  </div>
