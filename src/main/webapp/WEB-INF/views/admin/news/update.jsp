	            ...
	            <div class="panel-heading">
	              <h4 class="panel-title"></h4>
	                ...
	                <div class="panel-body">
	                  <div class="row">
                        <div class="col-md-12">
				          <form action="/news/update" class="form" enctype="multipart/form-data" method="post">
				            <div class="form-group">
				              ...
				              <div class="col-md-4">
				                <div class="form-group has-warning" style="position: absolute; right: 50px; top: 0px; width:86%;">
				              	...
				              	<input type="text" name="title" value="${newsUpdate.title}" class="form-control" style="width:66.5%;">
				              </div>
			              	 <div class="form-group">
				         		<textarea class="form-control" name="content" rows="10">${newsUpdate.content}</textarea>
				        	</div>
				        	<input type="hidden" name="id" value="${newsUpdate.id}"/>
