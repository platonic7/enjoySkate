	        ...
	        <div class="col-md-12">
	          <div class="panel panel-info">
	            <div class="panel-heading">
	              <h3 class="panel-title"><img src="/resources/HTML/UI/Flat-UI-Pro-1.3.2/docs/assets/img/icons/mic.svg" style="max-width: 3%; alt="" />&nbsp;&nbsp;${spot.title}</h3>
	            </div>
	            <div class="panel-body">
	              ...
	              ${spot.user.username}&nbsp;&nbsp; 입력&nbsp;&nbsp;${spot.updatedTime}
	   			</div>
	   			 <p style="clear:both;">&nbsp;</p>
		         <img alt="" style="max-width: 100%; height: auto;" vspace="20" src="<c:url value="${spot.imagePath }" />" >
					<div id="test">
					<pre><h3><c:out value="${spot.content}"/></h3></pre>
					</div>
		       </div>
		     </div>
		   </div>
...
<div class="container">
	 <form action="/spotComment" method="post" >
	<table>
		<tr>
	  	  <td><input name="spotId" type="hidden" value="${spot.id }"></td>
 ...
 <br />
 <div class="container">
	   <c:forEach items="${spot.boardcommentList}" var="boardComment">
	     <dl>
	  		...
	  		<dd><a href="/spots/${boardComment.id}/commentUpdate" class="btn">UpDate</a>
	  		<a href="/spots/${boardComment.id}/commentDelete" class="btn">Delete</a></dd>
		</dl>
	  </c:forEach>
 </div>
